...
urlpatterns = [
    ...
    path('lead-magnet/', RedirectView.as_view(pattern_name='free_guide', permanent=True)),
    path('lead-magnet/thanks/', RedirectView.as_view(pattern_name='free_guide_thanks', permanent=True)),
